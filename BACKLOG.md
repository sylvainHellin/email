...
- [#0086 Server search parity: one grammar, per-backend translation, Outlook-shape TUI form](docs/tickets/0086-server-search-parity.md) -- feature _(closes the #0043 two-grammar debt; **#0086a engine + CLI shipped**; **#0086b** TUI Outlook-shape form remains; #0086c saved searches dropped)_
